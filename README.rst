...
Less than 5 minutes:
    ...
    Step by Step for Ubuntu:
        ...
        - curl -O https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.5.0.tar.gz
        - tar xfvz elasticsearch-7.5.0.tar.gz
        - cd elasticsearch
        - bin/elasticsearch &
...
Deployed with Elasticsearch 7.5.0
